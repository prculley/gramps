    ...
    additional_ui.append('''
        <section id="PopUpTree">
          <item>
            ...
            <attribute name="label" translatable="yes">Expand this Entire Group</attribute>
          </item>
          <item>
            <attribute name="action">win.CloseBranch</attribute>
            <attribute name="label" translatable="yes">Collapse this Entire Group</attribute>
          </item>
          <item>
          ...
          <item>
            <attribute name="action">win.CCloseAllNodes</attribute>
