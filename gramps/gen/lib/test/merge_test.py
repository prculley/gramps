...
class PlaceCheck(unittest.TestCase, PrivacyBaseTest, MediaBaseTest,
    ...
    def test_merge_both_different_sort_date(self):
        ...
        self.phoenix.add_name(self.utrecht)
        ptype1 = PlaceType(value=PlaceType.HAMLET,
                           date=_dp.parse("before 1960"))
        self.phoenix.set_type(ptype1)
        ptype2 = PlaceType(value=PlaceType.VILLAGE,
                           date=_dp.parse("from 1960 to 1970"))
        ...
        self.titanic.add_name(self.leiden)
        ptype3 = PlaceType(value=PlaceType.CITY,
                           date=_dp.parse("after 1980"))
        self.titanic.set_type(ptype3)
        ptype4 = PlaceType(value=PlaceType.TOWN,
                           date=_dp.parse("from 1970 to 1980"))
