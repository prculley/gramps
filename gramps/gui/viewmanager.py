...
from .uimanager import ActionGroup, UIManager
...
class ViewManager(CLIManager):
    ...
    **Overview**
    ...
    def __build_main_window(self):
        ...
        vbox = Gtk.Box(orientation=Gtk.Orientation.VERTICAL)  #Gtk.Grid(expand=True)
        ...
        #openbtn = self.uimanager.get_widget('OpenBtn')
    ...
    def __keypress(self, action, value):
        """
    ...
    def enable_menu(self, enable):
        ...
        if not enable:
            self.action_st = (
                ...
                self.uimanager.get_actions_sensitive(self.recent_manager.action_group))
            ...
            self.uimanager.set_actions_sensitive(self.actiongroup, self.action_st[0])
            self.uimanager.set_actions_sensitive(self.readonlygroup, self.action_st[1])
            self.uimanager.set_actions_sensitive(self.undoactions, self.action_st[2])
            self.uimanager.set_actions_sensitive(self.redoactions, self.action_st[3])
            self.uimanager.set_actions_sensitive(self.fileactions, self.action_st[4])
            self.uimanager.set_actions_sensitive(self.toolactions, self.action_st[5])
